describe("Tests per-room border functions", function()
  ...
  describe("Tests setRoomBorderColor", function()
    ...
    it("should reject invalid color values", function()
      assert.has_error(function()
        setRoomBorderColor(testRoomId, 256, 0, 0)
      end)
      assert.has_error(function()
        setRoomBorderColor(testRoomId, -1, 0, 0)
      end)
    end)

    it("should reject invalid room ID", function()
      assert.has_error(function()
        setRoomBorderColor(-999, 255, 0, 0)
      end)
    end)
  end)
  ...
  describe("Tests setRoomBorderThickness", function()
    ...
    it("should reject thickness below 1", function()
      assert.has_error(function()
        setRoomBorderThickness(testRoomId, 0)
      end)
    end)

    it("should reject thickness above 10", function()
      assert.has_error(function()
        setRoomBorderThickness(testRoomId, 11)
      end)
    end)
  end)
